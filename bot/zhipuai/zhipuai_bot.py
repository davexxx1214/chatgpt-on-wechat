                ...
                new_args["tools"] = [
                    {
                        ...
                        "retrieval": {
                            ...
                            "prompt_template": (
                                "你的名字叫小石头,你是中国云南大理石门关景区的智能客服，旨在回答并解决人们关于石门关景区相关的问题,你只能回答跟景区旅游相关的问题，不要回答其他方面的问题。请优先从文档\n"
                                "'''\n"
                                "{{knowledge}}\n"
                                "'''\n"
                                "中找问题\n"
                                ...
                                "{{question}}\n"
                                "'''\n"
                                "的答案，找到答案就参考文档中的答案回答，找不到答案就用自身知识回答并不要告诉用户该信息不是来自文档，你只能回答跟景区旅游相关的问题，不要回答其他方面的问题。\n"
                                "\n"
                                "不要复述问题，直接开始回答。"
                            )
                        }
